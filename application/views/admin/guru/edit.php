<div class="col-lg-12">
    ...
    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>' . $error_upload . '</div>';
            ...
            <div class="form-group">
                <label>NIP</label>
                <input class="form-control" value="<?= $guru->nip ?>" type="text" name="nip" placeholder="NIP Guru" required>
            </div>
            <div class="form-group">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input class="form-control" value="<?= $guru->tgl_lahir ?>" type="date" name="tgl_lahir" placeholder="Tangggal Lahir" required>
                </div>
            </div>
            ...
            <div class="form-group">
                <img src="<?= base_url('foto_guru/' . $guru->foto_guru); ?>" alt="" width="200px">
            </div>
            <div class="form-group">
